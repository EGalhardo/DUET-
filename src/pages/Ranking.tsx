                ...
                <div className="w-full bg-emerald-50/45 rounded-3xl md:rounded-full p-4 px-6 md:px-12 flex flex-col sm:flex-row items-start sm:items-center justify-start gap-6 sm:gap-14 transition-all duration-300">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="text-[9px] md:text-[10px] font-black text-emerald-650 uppercase tracking-wider mt-0.5 leading-none">
                        Vencedor da aposta
                      </span>
                      <span className="text-[8px] md:text-[9px] font-bold text-slate-400 uppercase tracking-tight mt-0.5">
                  ...
                  <div className="text-left flex flex-col shrink-0 sm:pl-4">
                    ...
                    <span className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none mt-0.5">
                      Prémio recebido
                    </span>
                  </div>
                </div>
            ...
            >
              ...
              {displayedRankings.length === 0 ? (
                ...
                displayedRankings.map((player, i) => {
                  const originalIndex = currentRankings.findIndex(
                    (p) => p.id === player.id,
                  );
                  const userRankIndex = currentRankings.findIndex(
                    (p) => p.id === 999999,
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="flex-1 font-bold text-[#091747] flex items-center gap-1.5 min-w-0">
                        ...
                        {player.isCurrentUser && (
                          <span className="bg-amber-150 text-amber-900 border border-amber-300 text-[8px] font-black uppercase px-2 py-0.5 rounded-full tracking-wider shrink-0 shadow-xs">
                            Tu
                          </span>
                        )}
                      </span>
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {(!player.isCurrentUser || player.id === 999999) && (
                          <button
                            onClick={() => {
                              if (player.id === 999999 || isBelowUser) {
                                setTargetPlayer(player);
                                setIsModalOpen(true);
                              }
                            }}
                            disabled={player.id !== 999999 && !isBelowUser}
                            className={cn(
                              "flex items-center gap-1 px-2.5 py-1.5 rounded-full text-[9px] font-black uppercase tracking-wider transition-all duration-300",
                              (player.id === 999999 || isBelowUser)
                            ...
                            title={
                              (player.id === 999999 || isBelowUser)
                                ...
                                : `Deves superá-lo no ranking para lhe podas enviar um Imojin (apenas para quem está abaixo de ti).`
                            }
                          >
                            <Smile className={cn("w-3.5 h-3.5", (player.id === 999999 || isBelowUser) && "text-amber-500 animate-pulse")} />
          ...
          {toastMsg && (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] font-bold text-slate-100 mt-0.5 whitespace-pre-wrap">{toastMsg}</p>
              </div>
              <button 
              ...
              >
                ...
                <div className="flex items-center gap-4 pb-5 border-b border-slate-100/80 mb-5 shrink-0">
                  <div className="relative">
                    ...
                    />
                    <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-[#FFB10A] rounded-full flex items-center justify-center text-white border-2 border-white shadow-sm font-black text-[9px] tracking-tighter">
